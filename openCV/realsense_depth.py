...
from pyrealsense2 import align, frame
...
class DepthCamera:
    ...
    def get_frame(self):
        ...
        depth_info = depth_frame.as_depth_frame() # 깊이 프레임 가져오기
        ...
        return True, depth_image, color_image, depth_info   # 깊이와 컬러 이미지가 있으면 True와 함께 반환
