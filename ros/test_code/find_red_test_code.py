...
def listen_for_signal():
    ...
    while True:
        ...
        if "Red detected" in message:
            ...
            if match:
                # Extract the two integers and convert them to integers
                initial_x, initial_y = int(match.group(1)), int(match.group(2))
                print("Extracted coordinates:", (initial_x, initial_y))
